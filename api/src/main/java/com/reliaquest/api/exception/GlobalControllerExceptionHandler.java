...
import com.reliaquest.api.model.APIError;
...
public class GlobalControllerExceptionHandler {
    ...
    @ExceptionHandler(EmployeeServiceRemoteException.class)
    public ResponseEntity<APIError> handleEmployeeServiceIntegrationException(EmployeeServiceRemoteException ex) {
